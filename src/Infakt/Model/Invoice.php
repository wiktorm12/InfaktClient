...
class Invoice implements EntityInterface
{
    ...
    public function toArray(): array
    {
        $arrayResult = [
            ...
            'paid_date' => $this->paidDate ? $this->paidDate->format('Y-m-d') : null,
            'notes' => $this->notes,
            'kind' => $this->kind,
            'payment_method' => $this->paymentMethod,
            'recipient_signature' => $this->recipientSignature,
            'seller_signature' => $this->sellerSignature,
            'invoice_date' => $this->invoiceDate ? $this->invoiceDate->format('Y-m-d') : null,
            'sale_date' => $this->saleDate ? $this->saleDate->format('Y-m-d') : null,
            'status' => $this->status,
